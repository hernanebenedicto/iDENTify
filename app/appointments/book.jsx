...
const styles = StyleSheet.create({
  ...
  card: { width: '47%', backgroundColor: "white", paddingVertical: 24, paddingHorizontal: 16, borderRadius: 20, alignItems: "center", justifyContent: 'center', marginBottom: 16, shadowColor: "#64748B", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 3, borderWidth: 1, borderColor: "#F1F5F9" },
